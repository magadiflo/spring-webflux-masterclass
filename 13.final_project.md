...
con las siguientes configuraciones. Adicionalmente, agregaremos de manera manual la dependencia de `MockServer`.
...
- **Spring WebFlux** → Permite construir controladores reactivos y manejar peticiones de manera no bloqueante, ideal
  para un servicio que orquesta llamadas a otros microservicios.
