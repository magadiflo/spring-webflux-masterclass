...
## 🧪 Probando Server-Sent Events (SSE): filtro de precios

Al ejecutar nuestra aplicación `WebfluxPlaygroundApplication`, los productos se insertan automáticamente cada 1
segundo gracias a la clase `DataSetupService`.

Luego, abrimos dos navegadores distintos apuntando a la URL `http://localhost:8080` y configuramos filtros diferentes:

- `Navegador A` → recibe notificaciones de productos con precio menor que 50.
- `Navegador B` → recibe notificaciones de productos con precio menor que 80.

![08.png](assets/section-11/08.png)

#### 🔎 Explicación del comportamiento

- Cada navegador abre su propia conexión `SSE` al endpoint `/api/v1/products/stream/{maxPrice}`.
- El backend aplica el filtro dinámico en el `Flux` antes de enviar los productos.
- Aunque ambos clientes están conectados al mismo `Sink`, cada uno recibe únicamente los productos que cumplen su
  criterio.
- La tabla en cada navegador se actualiza automáticamente en tiempo real, sin necesidad de recargar la página.

### ✅ Conclusión

Este caso de prueba demuestra que:

- La **simulación automática de productos** funciona correctamente.
- El **filtro dinámico por precio** se aplica de manera independiente para cada cliente.
- La experiencia de visualización en tiempo real es **personalizada y eficiente**, ya que cada usuario recibe solo la
  información que le interesa.

## 🧪 Test de Integración para Server-Sent Events (SSE)

En esta prueba verificamos que el endpoint `SSE` (`/api/v1/products/stream/{maxPrice}`) funciona correctamente y
devuelve solo productos cuyo precio sea menor o igual al valor especificado.
...
- `@SpringBootTest(properties = "section=sec11")`, levanta el contexto completo de `Spring Boot` para pruebas de
  integración. La propiedad `section=sec11` puede ser utilizada en tus `application.yml` para cargar configuraciones
  específicas.
- `@AutoConfigureWebTestClient`, activa la configuración automática del `WebTestClient`, el cliente reactivo de pruebas
  para `WebFlux`.
- `client.get().uri(...)`, realiza una llamada HTTP GET al endpoint SSE con el filtro de precio `{maxPrice} = 80`.
- `.accept(MediaType.TEXT_EVENT_STREAM)`, indica que el cliente espera un stream SSE como respuesta.
- `.exchange()`, ejecuta la llamada HTTP.
- `.expectStatus().is2xxSuccessful()`, verifica que el código de respuesta esté en el rango de 200 (éxito).
- `.returnResult(ProductResponse.class).getResponseBody()`, obtiene el cuerpo de la respuesta como
  `Flux<ProductResponse>`.
- `.take(3)`, toma los primeros 3 productos emitidos por el stream. Esto es clave para que el test no se quede colgado
  esperando eventos infinitos.
- `.doOnNext(...)`, loguea cada producto recibido (útil para depuración)
- `.collectList()`, recolecta los 3 productos en una lista.
- `.as(StepVerifier::create)`, pasa esa lista a `StepVerifier`, herramienta de pruebas para flujos reactivos.
- `.assertNext(...)`, verifica que:
    - Se recivieron los 3 productos.
    - Todos tienen precio <= 80
- `.verifyComplete()`, asegura que el flujo terminó correctamente después de los 3 elementos esperados.

### 📌 Ejecución de pruebas desde cmd

````bash
D:\programming\spring\01.udemy\03.vinoth_selvaraj\spring-webflux-masterclass\projects\webflux-playground (feature/section-11)
$ mvn test -Dtest="*/sec11/*"
[INFO] Scanning for projects...
[INFO]
[INFO] ------------------< dev.magadiflo:webflux-playground >------------------
...
2026-04-22T13:41:11.349-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [0] to: product-1
2026-04-22T13:41:11.350-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [1] to: 29
2026-04-22T13:41:11.366-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.QUERY                : Executing query: INSERT INTO "products" ("description", "price") VALUES ($1, $2) RETURNING "id"
2026-04-22T13:41:11.381-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.a.s.service.impl.DataSetupService    : product saved: ProductResponse[id=11, description=product-1, price=29]
2026-04-22T13:41:11.480-05:00  INFO 6776 --- [webflux-playground] [           main] d.m.app.sec11.ServerSentEventsTest       : productResponse: ProductResponse[id=11, description=product-1, price=29]
2026-04-22T13:41:12.341-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [0] to: product-2
2026-04-22T13:41:12.341-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [1] to: 99
2026-04-22T13:41:12.341-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.QUERY                : Executing query: INSERT INTO "products" ("description", "price") VALUES ($1, $2) RETURNING "id"
2026-04-22T13:41:12.343-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.a.s.service.impl.DataSetupService    : product saved: ProductResponse[id=12, description=product-2, price=99]
2026-04-22T13:41:13.342-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [0] to: product-3
2026-04-22T13:41:13.342-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [1] to: 86
2026-04-22T13:41:13.344-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.QUERY                : Executing query: INSERT INTO "products" ("description", "price") VALUES ($1, $2) RETURNING "id"
2026-04-22T13:41:13.345-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.a.s.service.impl.DataSetupService    : product saved: ProductResponse[id=13, description=product-3, price=86]
2026-04-22T13:41:14.344-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [0] to: product-4
2026-04-22T13:41:14.344-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [1] to: 92
2026-04-22T13:41:14.344-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.QUERY                : Executing query: INSERT INTO "products" ("description", "price") VALUES ($1, $2) RETURNING "id"
2026-04-22T13:41:14.346-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.a.s.service.impl.DataSetupService    : product saved: ProductResponse[id=14, description=product-4, price=92]
2026-04-22T13:41:15.347-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [0] to: product-5
2026-04-22T13:41:15.347-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [1] to: 75
2026-04-22T13:41:15.347-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.QUERY                : Executing query: INSERT INTO "products" ("description", "price") VALUES ($1, $2) RETURNING "id"
2026-04-22T13:41:15.351-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.app.sec11.ServerSentEventsTest       : productResponse: ProductResponse[id=15, description=product-5, price=75]
2026-04-22T13:41:15.352-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.a.s.service.impl.DataSetupService    : product saved: ProductResponse[id=15, description=product-5, price=75]
2026-04-22T13:41:16.348-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [0] to: product-6
2026-04-22T13:41:16.349-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.PARAM                : Bind parameter [1] to: 50
2026-04-22T13:41:16.349-05:00 DEBUG 6776 --- [webflux-playground] [actor-tcp-nio-3] io.r2dbc.postgresql.QUERY                : Executing query: INSERT INTO "products" ("description", "price") VALUES ($1, $2) RETURNING "id"
2026-04-22T13:41:16.351-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.app.sec11.ServerSentEventsTest       : productResponse: ProductResponse[id=16, description=product-6, price=50]
2026-04-22T13:41:16.390-05:00  INFO 6776 --- [webflux-playground] [actor-tcp-nio-3] d.m.a.s.service.impl.DataSetupService    : product saved: ProductResponse[id=16, description=product-6, price=50]
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 9.035 s -- in dev.magadiflo.app.sec11.ServerSentEventsTest
[INFO]
[INFO] Results:
[INFO]
...
[INFO] Finished at: 2026-04-22T13:41:16-05:00
[INFO] ------------------------------------------------------------------------
````
...
- El endpoint SSE responde correctamente con un stream de productos.
- El filtro dinámico por precio funciona como se espera.
- La integración entre `controlador → servicio → Sink → SSE → cliente` está validada de extremo a extremo.
